Sub MEJ_GI_Nombre()
    ...
    wbkOpen.Worksheets("Feuil1").Range("Y7:AD8").Copy wbkThis.Worksheets("Feuil1").Range("B58")
    ...
    With wbkThis.Worksheets("Feuil1")
        .Range("G61").FormulaR1C1 = "=SUM(RC[-4]:RC[-1])"        
        ...
        .Range("G60").FormulaR1C1 = .Range("G59").Value / .Range("G61").Value
        ...
        .Range("G58").FormulaR1C1 = "Avant 2016"

        .Range("B61:G61").Delete Shift:=xlToLeft
        .Range("C60:G60").NumberFormat = "0.00"
        .Range("B59:G59").Font.Bold = False
        
        With .Range("B59:G59").Interior
             .Pattern = xlNone
             .TintAndShade = 0
